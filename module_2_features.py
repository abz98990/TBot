...
class FeatureEngineer:
    ...
    def apply_technical_indicators(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # 4. Momentum: MACD
        # macd returns columns: MACD_12_26_9, MACDh_12_26_9 (histogram), MACDs_12_26_9 (signal)
        macd = df.ta.macd(fast=12, slow=26, signal=9)
        df = pd.concat([df, macd], axis=1)

        # 5. Trend Strength: ADX
        # adx returns columns: ADX_14, DMP_14, DMN_14
        ...
        # Define our final feature set (6 dimensions)
        self.feature_columns = ['RSI_14', 'ATR_pct', 'EMA_50_dist', 'MACD_12_26_9', 'MACDs_12_26_9', 'ADX_14']
        return df
